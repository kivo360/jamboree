class ModelSearchExample(object):
    """ 
        # Model Search 
        - We're doing the same thing we did for searching through datasets. 
        - Except this time we're doing it for machine learning models
        
        ## Here's the process we'll have
        1. Create a model
